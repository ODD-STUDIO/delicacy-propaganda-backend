        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text"  name="franchiseesName" lay-verify="required|name" value="${joinInfo.franchiseesName}" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text"  name="franchiseesPhonenum" lay-verify="required|phoneNum" value="${joinInfo.franchiseesPhonenum}" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text"  name="franchiseesAddress" lay-verify="address" value="${joinInfo.franchiseesAddress}" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">申请理由</label>
                <div class="layui-input-block">
                    <textarea name="franchiseesReason" lay-verify="reason" class="layui-textarea">${joinInfo.franchiseesReason}</textarea>
                </div>
            </div>
    ...
    <script>
        layui.use(['form','layer'], function () {
            ...
            form.on('submit(edit)', function(data){
                ...
                $.ajax({
                    type: "post",// 提交的http方法
                    url: "/back/admin/join/update", // 提交到后端的接口
