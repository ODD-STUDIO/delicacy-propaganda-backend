...
<div class="header">
    ...
    <div class="head clearfix">
        ...
        <ul class="nav clearfix">
            ...
            <li class="now"><a href="about">关于我们<span>ABOUT</span></a></li>
...
<div class="about">
    <div class="box clearfix">
        <div class="box_am box_a1 clearfix">
            <div class="tu tu_l"><img src="${pageContext.request.contextPath}/static/front/upload/about1.jpg" alt=""/>
            </div>
            <div class="wen wen_r">
    ...
    <div class="box clearfix">
        <div class="box_am box_a2 clearfix">
            <div class="tu tu_r"><img src="${pageContext.request.contextPath}/static/front/upload/about2.jpg" alt=""/>
            </div>
            <div class="wen wen_l">
                <div class="name">我们的历史<span>OUR HISTORY</span></div>
                <p>
                    公司主要经营泡沫茶饮，黑茶是以招牌“用新鲜茶叶泡制”茶系为主辅，辅以其它新鲜特色饮料，以及现煮研磨咖啡和更为受广大顾客接受认可的奶茶系列等，近100种产品，可依各地域性的风味来挑选，我们一直坚持‘新鲜、自然、无负担’的健康理念调配呈现给每一位顾客一杯美味舒心、健康、高品质的茶饮。我们的装修以黑白为主色调、尽显其简约、时尚风格。</p>
            </div>
        </div>
    </div>
    <div class="box clearfix">
        <div class="box_am box_a3 clearfix">
            <div class="tu tu_l"><img src="${pageContext.request.contextPath}/static/front/upload/about3.jpg" alt=""/>
            </div>
            <div class="wen wen_r">
    ...
    <div class="box clearfix no_line">
        <div class="box_am box_a4 clearfix">
            <div class="tu tu_r"><img src="${pageContext.request.contextPath}/static/front/upload/about4.jpg" alt=""/>
            </div>
            <div class="wen wen_l">
