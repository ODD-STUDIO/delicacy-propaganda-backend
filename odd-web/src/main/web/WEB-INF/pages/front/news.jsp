...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/front/plugins/FlexSlider/flexslider.css">
<script type="text/javascript" src="${pageContext.request.contextPath}/static/front/plugins/FlexSlider/jquery.flexslider.js"></script>
...
<div class="header">
    ...
    <div class="head clearfix">
        ...
        <ul class="nav clearfix">
            ...
            <li class="now"><a href="news.jsp">新闻中心<span>NEWS</span></a></li>
...
<div class="banner banner_s">
	<img src="${pageContext.request.contextPath}/static/front/upload/banner_d.jpg" alt=""/>
    <div class="jt">&nbsp;</div>
</div>
<!--幻灯片-->
<div class="box">
	...
	<div class="left">
        <div class="slider">
            <div class="flexslider">
              <ul class="slides">
                <li>
                    <img src="${pageContext.request.contextPath}/static/front/upload/pic1.jpg" alt="" />
                </li>
                <li>
                    <img src="${pageContext.request.contextPath}/static/front/upload/pic1.jpg" alt="" />
                </li>
